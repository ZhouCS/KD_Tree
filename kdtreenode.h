...
namespace  KDTree
{
    ...
    public:
        ...
        KDTreeNode():_left_child(0),_right_child(0),_parent(0),_split_dim(0){}

        KDTreeNode(KDTreeNode *left_child,KDTreeNode *right_child,KDTreeNode *parent,
        ...
        _HyperRectangle& getHyperRectangle(){
            return _range_hr;
        }
        ...
        void create(KDTreeNode *left_child,KDTreeNode *right_child,KDTreeNode *parent,
            int split_dim,_Examplar dom_elt,_HyperRectangle range_hr
        );
    };
}
