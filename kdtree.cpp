...
std::pair<KDTree::_Examplar, double> KDTree::KDTree::findNearest( _Examplar target )
{
...
int KDTree::KDTree::findNearest( _Examplar target, double range, std::vector<std::pair<_Examplar, double>> &res_nearest )
{
